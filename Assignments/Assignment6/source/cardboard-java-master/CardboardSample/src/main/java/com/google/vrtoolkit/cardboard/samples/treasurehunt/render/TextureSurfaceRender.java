 ...
 */
public abstract class TextureSurfaceRender implements Runnable {
    public static String LOG_TAG = TextureSurfaceRender.class.getSimpleName();
    ...
    public TextureSurfaceRender(SurfaceTexture surfaceTexture, int width, int height) {
