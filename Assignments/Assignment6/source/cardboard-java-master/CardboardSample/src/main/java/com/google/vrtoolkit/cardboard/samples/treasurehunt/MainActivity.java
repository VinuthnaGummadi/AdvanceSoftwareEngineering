...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
  ...
  private static final String OBJECT_SOUND_FILE = "remote.wav";
  private static final String SUCCESS_SOUND_FILE = "gunshot.wav";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    overlayView.show3DToast("Pull the magnet when you find a UFO.");
  }
  ...
  public void onCardboardTrigger() {
    ...
    if (isLookingAtObject()) {
      ...
      successSourceId = gvrAudioEngine.createStereoSound(SUCCESS_SOUND_FILE);
      gvrAudioEngine.playSound(successSourceId, false);
      overlayView.show3DToast("Look around to find the UFO!");
    }
